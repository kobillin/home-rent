...
<section class="wrapper" style="margin-left: 16%;margin-top: -23%;">
	<div class="container">
		<div class="row">
			...
			?>
			<h2>Apartments and Single Rooms</h2>
				<?php 
					foreach ($data as $key => $value) {						
						echo '<div class="card card-inverse card-info mb-3" style="padding:1%;">					
								  <div class="card-block">';
								  	...
								  	// echo '<a style"margin-right:20px;" class="btn btn-danger float-right" href="delete.php?id='.$value['id'].'&act=';if(!empty($value['own'])){ echo "ap"; }else{ echo "indi"; } echo '">Delete</a>';
									 echo 	'<div class="row">
											<div class="col-4">
										...
										echo '</div>
											...
											echo '<p><b>Description: </b>'.$value['description'].'</p>';
												if($value['vacant'] == 0){ 
													...
													echo '<a class="btn btn-danger float-right" href="book.php?id='.$value['id'].'&act=';if(!empty($value['own'])){ echo "ap"; }else{ echo "indi"; } echo '">Book Now!</a>';
													// echo '<a class="btn btn-danger float-right" href="../app/complaint.php?id=$id">Book Now!</a><br><br>';
												} 
											echo '</div>
										</div>				      
								   </div>
								</div>';
								echo '<a class="btn btn-warning float-right" href="../app/complaint.php?id=$id">Complaint</a><br><br>';
