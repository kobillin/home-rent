...
//land starts here!
	if(isset($_POST['register_land'])) {
			...
			try {
					$stmt = $connect->prepare('INSERT INTO registrations_land (fullname, email, mobile, alternat_mobile, land_number, county, town, city, address, landmark, lease, sale, deposit, description, image, facilities, vacant, user_id) VALUES (:fullname, :email, :mobile, :alternat_mobile, :land_number, :county, :town, :city, :address, :landmark, :lease, :sale, :deposit, :description, :image, :facilities, :vacant, :user_id)');
					$stmt->execute(array(
						':fullname' => $fullname,
						':email' => $email,
						':mobile' => $mobile,
...
<section class="wrapper" style="margin-left: 16%;margin-top: -11%;">
	...
	<ul class="nav nav-tabs" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Add a Single Room</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" data-toggle="tab" href="#profile" role="tab">Add an Apartment Room</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" data-toggle="tab" href="#land" role="tab">Add Land</a>
	  </li>
	</ul>
