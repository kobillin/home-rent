  ...
  <body id="page-top">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center" style="color: #FED136">
            <h2 class="section-heading text-uppercase">Search FOR PROPERTY</h2>
            <h3 class="section-subheading text-muted">"Search rooms, land or homes."</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <span class="copyright">Copyright &copy; Real Estate 2020</span>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <a class="navbar-brand js-scroll-trigger btn btn-success" href="#page-top"  >TOP!</a>
          </div>
        </div>
      </div>
    </footer>
